...
```{r}
#El promedio de la variable "ppquechua" para toda la muestra es un promedio ponderado. Multiplicamos cada promedio de estrao por su peso y los sumamos.

#Primero procedemos a sacar los promedios por estrato.
...
```
```{r}
#Luego procedemos a sacar los pesos por cada estrato.
w1224=N_mae_1224/n_mae_1224
w1224

w2564=N_mae_2564/n_mae_2564
w2564

w65=N_mae_65mas/n_mae_65mas
w65
```


```{r}
#Finalmente hacemos el cálculo de nuestra media ponderada.
mean_ppquechua_tot= (media_ppquechua_1224*w1224 + media_ppquechua_2564*w2564 + media_ppquechua_65mas*w65)
mean_ppquechua_tot
```
